    ...
    if ($result->num_rows === 1) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            $userData = [
                ...
                'bio' => 'Financial enthusiast and budget planner. Love tracking expenses and setting savings goals.'
            ];
            ...
            echo "<script>localStorage.setItem('userData', '" . $userDataJson . "');</script>";
            echo "<script>setTimeout(function() { window.location.href = '../av1.php'; }, 2000);</script>";
            exit();
        } else {
